    ...
    <div className="landingPageContainer">
      <nav className="landingnavbar">
        ...
        <div className="navbar-links-right">
          ...
          <a href="/signup" className="rightButton">
            Get Started
          </a>
      ...
      <div className="landingHome">
        <div className="landingHomeTextBox">
          ...
          <p>
            Unlock the secrets of cybersecurity through interactive learning
            experiences, engaging challenges, and expert guidance.
          </p>
          <div className="buttonBox">
            <div className="leftButton">
              <Link to="/challenge">Start Learning</Link>{" "}
              <SchoolOutlinedIcon className="icons" />
            </div>
            <div className="rightButton">
              <Link>Free teams demo</Link>{" "}
      ...
      <div className="sectionThree">
        ...
        <div className="sectionThreeGrid">
          ...
          <div className="sectionThreeRightMargin">
            <div className="sectionThreeGridLeft">
              <div className="sectionThreeGridLeftTextBox">
                <img src={rightIcon} />
                <h1>Complete and Earn Rewards</h1>
                <p>
      ...
      <div className="fullLP">
        <div
          className="card3Container"
          style={{
            backgroundImage: `url(${patternLP})`,
        ...
        >
          ...
          <div className="cardBody">
            <div className="rightBody">
              <Link>
                <p className="topParagraph">Sales Department </p>
              </Link>
              <h5>
                Our cybersecurity training for sales departments is <br />{" "}
                meticulously crafted to address the vulnerabilities <br /> and
                threats that sales teams face daily.
              </h5>
              <hr />
              <Link>
                <p className="smallParagraph">Finance Teams</p>
              </Link>
              <hr />
              <Link>
                <p className="smallParagraph">Human Resources</p>
              </Link>
              <hr />
              <Link>
                <p className="smallParagraph">Marketing Departments</p>
              </Link>
              <hr />
              <Link>
                <p className="smallParagraph">Procurement Teams</p>
              </Link>
              <hr />
              <Link>
                <p className="smallParagraph">Legal Departments</p>
              </Link>
              <hr />
              <Link>
                <p className="smallParagraph">Executive Teams</p>
              </Link>
            </div>
      ...
      <div className="communitySection">
        ...
        <div className="communityCard">
          ...
          <div className="communityCardText">
            ...
            <p>
              "Need help identifying a potentially
              <br />
        ...
        <div className="questionsBox">
          <div>
            <CollapsibleBox title="Is ShieldEd suitable for beginners?">
              <p>
                Yes, ShieldEd is suitable for beginners and users of all skill
                levels. The platform offers introductory courses covering
                fundamental cybersecurity concepts in an accessible and
                easy-to-understand manner. ShieldEd's user-friendly interface
                and interactive learning approach make it ideal for individuals
                who are new to cybersecurity and want to build a solid
